...
<?php
      ...
      if ( ($_FILES["upfile"]["type"] == "image/jpeg") or ($_FILES["upfile"]["type"] == "image/png") ) 
        {   
		 ...
		 $good_type=htmlspecialchars($_POST['type']);
		 /**將上傳之資料存到image資料夾**/
         ...
         /**將商品存進商品資料表**/
         $sql="INSERT INTO good_table (good_id,good_name,good_price,good_location,good_seller,good_text,upload_time) VALUES('$good_id','$good_name','$good_price','$good_location', '$good_seller','$good_text',now())";
		 ...
		 {	
          if(mysqli_query($s,$sql))
           {	
			 ...
			 <div id='name'>商品名稱：" . $good_name ."</div><br><br>
			 <div id='pic'>預覽圖：</div>
...
img{border-style:solid;	position:absolute;top:100;left:125;}
#name{position:absolute;top:70;left:46;}
