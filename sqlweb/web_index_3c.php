...
<html>
 ...
 <head>
  ...
  <body>
	...
	$sql=mysqli_query($s,"SELECT COUNT(good_table_id) FROM good_table_3c ");
	$row=mysqli_fetch_array($sql);//$row[0]=有幾張圖片
	
	
	for($i=1;$i<=$row[0];$i++)
	{
	 $sql2=mysqli_query($s,"SELECT * FROM good_table_3c WHERE good_table_id= '$i' ");
	 ...
	 echo " <a href='good_text.php?web=2&text=".$row2[6]."'> <img  src=' ".$row2[5] . " ' height='50' width='50' ></a><br>";       
