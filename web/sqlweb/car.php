 ...
 if( @$_SESSION['username'])	 
 {
  ...
  {	 
	  ...
	  if($good_seller!=$_SESSION['username'])//商品不是自己上傳的商品才能買
	  {
	     ...
	     /**讀取重複購買的資料**/
         $repeat=mysqli_query($s,"SELECT goods_num FROM $car_table WHERE goods_id='$good_id'");
 	     ...
 	     if($repeat_num)
	     {
	        ...
	        mysqli_query($s,"UPDATE $car_table SET goods_num='$total' WHERE goods_id='$good_id'");
